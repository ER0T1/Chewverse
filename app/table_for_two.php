...
<head>
    <meta charset="UTF-8">
    <title>Chewverse - Table For Two</title>
    <!-- CSS -->
...
<body>
    <div class="container my-5">
        <div class="row d-flex justify-content-flex-start align-items-center mb-4">
            ...
            <h2 class="col text-left fw-bold mb-0">Table For Two</h2>
        </div>

        <!-- Table For Two content goes here -->
        <div class="content">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.addEventListener('topicSelected', function(event) {
                ...
                // 實際執行 AI 聊天功能
                window.location.href = 'table_for_two_chating.php';
            });
        });
    </script>
</body>
